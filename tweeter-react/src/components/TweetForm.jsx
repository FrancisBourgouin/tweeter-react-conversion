  ...
  return (
    <section className="newtweet">
      <form onSubmit={submitTweet} className="newtweet__form">
        <textarea className="form__textarea" name="text" placeholder="What are you humming about?" value={tweetText} onChange={event => setTweetText(event.target.value)} ></textarea>
